defmodule Sector7g.PromEx do
  ...
  1. Update your configuration (config.exs, dev.exs, prod.exs, releases.exs, etc) to
     ...
     ```
     config :sector7g, Sector7g.PromEx,
       disabled: false,
  ...
  3. Update your `endpoint.ex` file to expose your metrics (or configure a standalone
     ...
     ```
     defmodule Sector7gWeb.Endpoint do
       use Phoenix.Endpoint, otp_app: :sector7g

       ...

       plug PromEx.Plug, prom_ex_module: Sector7g.PromEx
  ...
  def dashboards do
    [
      ...
      # {:sector7g, "/grafana_dashboards/user_metrics.json"}
    ]
  end
end
